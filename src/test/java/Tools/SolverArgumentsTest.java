...
class SolverArgumentsTest {
    ...
    void populateCommands() {
        String[] args = {"bfs", "RDUL", "4x4", "01_0001.txt", "4x4_01_0001_bfs_rdul_sol.txt", "4x4_01_0001_bfs_rdul_stats.txt"};
        ...
        assertEquals(PuzzleSize.of(4, 4), solverArguments.getSize());
